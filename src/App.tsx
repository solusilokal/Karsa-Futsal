...
import logoImg from './assets/karsa-logo.png';
import heroImg from './assets/karsa-hero.jpg';
import courtSintetisA from './assets/lapangan-sintetis-a.webp';
import courtVinylB from './assets/lapangan-vinyl-b.webp';
import courtSintetisC from './assets/lapangan-sintetis-c.webp';
...
export default function App() {
  const [lightbox, setLightbox] = useState<{ isOpen: boolean; image: string }>({ isOpen: false, image: '' });
